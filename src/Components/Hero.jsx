...
const Hero = () => {
  return (
    <div className="hero  lg:w-[1350px] lg:mx-auto py-12 bg-base-200 rounded-xl">
      <div className="hero-content flex-col lg:flex-row-reverse gap-60">
        ...
        <div className="space-y-12">
          ...
          <NavLink to='/listedbook'><button className="btn btn-success text-white text-base lg:text-lg">View The List</button></NavLink>
        </div>
      </div>
    </div>
  );
